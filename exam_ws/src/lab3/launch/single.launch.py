...
def generate_launch_description():
    ...
    marker_id_arg = DeclareLaunchArgument("marker_id", default_value="582", description="Marker ID. ")

    marker_size_arg = DeclareLaunchArgument("marker_size", default_value="0.04667", description="Marker size in m. ")
